# ============================================================
# SCRIPT: actualizar_homepage_dashboard.ps1
# Actualiza SOLO dashboard/src/pages/HomePage.tsx
# Combina: stats porcentajes + top favorito + acceso rapido
...
Write-Host "  DCH - Actualizando HomePage del dashboard" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
# Backup
$backupPath = "dashboard\src\pages\HomePage.tsx.backup_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
if (Test-Path "dashboard\src\pages\HomePage.tsx") {
    Copy-Item "dashboard\src\pages\HomePage.tsx" $backupPath -Force
    Write-Host "   Backup creado: $backupPath" -ForegroundColor Gray
}

Write-Host ">> Escribiendo nuevo HomePage.tsx..." -ForegroundColor Yellow
  ...
  return (
    <div className="space-y-6 p-1">
      <section>
        ...
        {/* Fila 4: tarjetas pequeñas de flags */}
...
Write-Host "   HomePage.tsx escrito correctamente." -ForegroundColor Green
Write-Host ""
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "  COMPLETADO" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Incluye todo junto:" -ForegroundColor White
Write-Host "  - Cards grandes: total restaurantes + sugerencias pendientes" -ForegroundColor Gray
Write-Host "  - Cards grandes: con/sin coordenadas" -ForegroundColor Gray
Write-Host "  - Card top favorito (si hay datos)" -ForegroundColor Gray
Write-Host "  - Tarjetas pequenas con porcentajes por flag (igual que antes)" -ForegroundColor Gray
Write-Host "  - Seccion acceso rapido con 3 botones" -ForegroundColor Gray
Write-Host ""
Write-Host "NOTA: Si el campo 'favoritos' no existe todavia en tu BD," -ForegroundColor Yellow
Write-Host "      la card de top favorito mostrara 'Aun sin favoritos'." -ForegroundColor Yellow
Write-Host "      Ejecuta la migracion si no lo hiciste:" -ForegroundColor Yellow
Write-Host "      cd backend && npx prisma migrate dev --name add_favoritos" -ForegroundColor Cyan
Write-Host ""
Write-Host "Arranca el dashboard:" -ForegroundColor White
