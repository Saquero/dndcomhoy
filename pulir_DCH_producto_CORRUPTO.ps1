          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea name="descripcion" value={form.descripcion} onChange={handleChange}
                placeholder="CuÃƒÂ©ntanos por que es un buen sitio para familias..." required rows={3}
...
# ============================================================
# 8. Dashboard HomePage Ã¢â‚¬â€ sin "Acceso rapido", sin icono roto
# ============================================================
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <BigCard
            ...
            value={pendingQ.isError ? "Ã¢â‚¬â€" : String(pendientes)}
...
# ============================================================
# 9. Dashboard RestaurantesPage Ã¢â‚¬â€ badge favoritos limpio
# ============================================================
...
if (Test-Path $restPagePath) {
    ...
    $content = $content -replace 'ÃƒÂ°Ã…Â¸"Ã‚Â¥[^\s"<]*', ''
    $content = $content -replace 'ÃƒÂ¢[^\s"<]*', ''
    $content = $content -replace 'Ã°Å¸â€Â¥\s*', ''

    # Normalizar el badge de favoritos si hay un patron reconocible
    $content = $content -replace '(\{[^}]*favoritos[^}]*>[^}]*\})', '{ r.favoritos > 0 ? `${r.favoritos} fav` : "0" }'
...
# ============================================================
# 10. Dashboard SugerenciasPage Ã¢â‚¬â€ limpiar simbolos corruptos
# ============================================================
...
if (Test-Path $sugPagePath) {
    ...
    $content = $content -replace 'ÃƒÂ°Ã…Â¸[^\s"<]*', ''
    $content = $content -replace 'ÃƒÂ¢[^\s"<]*', ''
    $utf8NoBom = New-Object System.Text.UTF8Encoding $false
    [System.IO.File]::WriteAllText(
        [System.IO.Path]::GetFullPath($sugPagePath),
